...
import 'package:tuto_domain_driven_design/domain/notes/value_transformers.dart';
...
class NoteBody extends ValueObject<String> {
  ...
  factory NoteBody(String input) {
    return NoteBody._(validateMaxStringLenght(input, maxLength)
...
class TodoName extends ValueObject<String> {
  ...
  factory TodoName(String input) {
    return TodoName._(validateMaxStringLenght(input, maxLength)
        .flatMap(validateStringNotEmpty)
